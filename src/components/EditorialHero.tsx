...
export default function EditorialHero({ onOpenDemo }: { onOpenDemo: () => void }) {
  ...
  return (
    <section className="relative z-10 min-h-[640px] overflow-hidden pt-9 lg:pt-10 flex flex-col justify-start gap-12 lg:gap-16">
      ...
      <div className="relative mx-auto max-w-8xl px-6 text-center">
        <motion.h1 {...rise(0.06)} className="mx-auto mt-2 max-w-4xl 2xl:max-w-5xl font-display text-[40px] font-black leading-[0.98] tracking-[-0.055em] text-neutral-950 sm:text-5xl lg:text-[56px] 2xl:text-[72px] dark:text-white">Your story travels further<br /><span className="text-indigo-650 dark:text-indigo-400">when people share it.</span></motion.h1>
        <motion.p {...rise(0.12)} className="mx-auto mt-2 max-w-xl 2xl:max-w-2xl text-[13px] 2xl:text-base leading-relaxed text-neutral-500 dark:text-neutral-400">Help the people closest to your brand share with confidence—and see the impact of every conversation.</motion.p>
