        ...
        <div className="max-w-3xl mx-auto mb-10">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 bg-white border border-slate-200 rounded-2xl text-sm focus:outline-hidden focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:border-transparent transition-all shadow-xs text-slate-900 placeholder:text-slate-400"
            />
          </div>
        </div>
                ...
                return (
                  ...
                  >
                    ...
                    <span className={[
                      ...
                      isActive ? 'bg-indigo-100 text-indigo-700' : 'bg-slate-200/60 text-slate-500'
                    ].join(' ')}>
              ...
              {filteredFAQs.length > 0 ? (
                    ...
                    >
                      ...
                      >
                        <div className="space-y-1">
                          <span className="text-[9px] font-mono font-extrabold uppercase tracking-widest text-indigo-500 block">
                            {faq.category}
                          </span>
                        ...
                        <div className={[
                          ...
                          isOpen ? 'rotate-180 bg-slate-50 text-indigo-600' : 'bg-white'
                        ].join(' ')}>
                ...
                >
                  ...
                  <button
                    ...
                    className="text-xs font-bold text-indigo-600 hover:text-indigo-700 bg-indigo-50 hover:bg-indigo-100 px-4 py-2 rounded-xl transition-all cursor-pointer"
                  >
                    Reset Filter
                  </button>
                </motion.div>
                ...
                <form onSubmit={handleAskSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2.5 bg-[#141418] border border-fixed-white/[0.1] rounded-xl text-xs text-fixed-white placeholder:text-fixed-muted focus:outline-hidden focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500"
                      />
                    </div>
                    <div>
                      <label className="text-[9px] font-mono uppercase tracking-wider text-fixed-muted block mb-1.5">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3.5 py-2.5 bg-[#141418] border border-fixed-white/[0.1] rounded-xl text-xs text-fixed-white placeholder:text-fixed-muted focus:outline-hidden focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 resize-none"
                    />
                  </div>
