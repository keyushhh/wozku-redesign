...
export const MOCK_LINKEDIN_POSTS: LinkedInPost[] = [
  {
    ...
    reactions: {
      countText: 'Rahul Sharma and 42 others',
  ...
  },
  {
    ...
    reactions: {
      countText: 'Priyanka Patel and 18 others',
  ...
  },
  {
    ...
    reactions: {
      countText: 'Priyanka Patel and 9 others',
