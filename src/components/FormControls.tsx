...
export function Input(props: React.InputHTMLAttributes<HTMLInputElement>) {
  return <input {...props} className={`w-full rounded-xl border border-neutral-200 bg-white px-3.5 text-xs text-neutral-900 placeholder:text-neutral-450 transition-all focus:border-primary-505 focus:ring-4 focus:ring-primary-100/60 focus:outline-hidden modal-control-height ${props.className ?? ''}`} />;
}
