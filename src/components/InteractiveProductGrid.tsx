...
export default function InteractiveProductGrid() {
  ...
  return (
    <div className="space-y-8 w-full max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="flex justify-center border-b border-neutral-200 dark:border-neutral-800 max-w-lg mx-auto pb-px">
      ...
      <div className="bg-white dark:bg-neutral-905 border border-neutral-200 dark:border-neutral-800 rounded-[2.5rem] p-8 sm:p-12 shadow-3xs relative overflow-hidden transition-all duration-300 min-h-[420px] flex items-center">
        <div className="absolute top-0 right-0 h-48 w-48 bg-radial-[at_top_right] from-indigo-500/5 via-transparent to-transparent pointer-events-none" />
          ...
          {activeTab === 'ugc' && (
            ...
            >
              <div className="lg:col-span-5 space-y-6 text-left">
                <div className="h-10 w-10 rounded-xl bg-indigo-50 dark:bg-indigo-950/20 border border-indigo-150 dark:border-indigo-850 flex items-center justify-center text-indigo-650 dark:text-indigo-400">
                  <Sparkles className="w-5 h-5" />
                </div>
                <div className="space-y-2">
                  <h4 className="text-xl sm:text-2xl font-display font-extrabold text-neutral-900 dark:text-fixed-white tracking-tight">
                    Guided UGC Studio
                  </h4>
                  <p className="text-sm text-neutral-500 dark:text-fixed-light leading-relaxed font-sans font-medium">
                ...
                {/* Proof Badge */}
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-150 dark:border-emerald-900 text-emerald-700 dark:text-emerald-400 text-xs font-mono font-bold">
              ...
              <div className="lg:col-span-7 flex justify-center">
                <div className="w-full max-w-md bg-[#0a0a0d] border border-fixed-white/10 rounded-2xl p-6 text-left space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-3 bg-[#141418] border border-fixed-white/5 rounded-xl text-[11px] text-fixed-light font-sans leading-relaxed border-l-2 border-indigo-500">
                      "Excited to attend the summit! Register organically here: <span className="text-indigo-400 font-bold">[Personalized Link]</span>"
                    </div>
                  </div>
          ...
          {activeTab === 'holdfire' && (
            ...
            >
              <div className="lg:col-span-5 space-y-6 text-left">
                ...
                {/* Proof Badge */}
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-50 dark:bg-indigo-950/20 border border-indigo-150 dark:border-indigo-900 text-indigo-700 dark:text-indigo-400 text-xs font-mono font-bold">
                  ...
                  <div className="space-y-2.5">
                    {[
                      ...
                      <div key={idx} className="flex justify-between items-center p-2 bg-[#141418] border border-fixed-white/5 rounded-xl text-[10.5px]">
                        ...
                        <span className="px-2 py-0.5 rounded-md bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 font-mono text-[9px] font-bold">
                          {item.status}
                        </span>
                      </div>
                    ))}
          ...
          {activeTab === 'dispatch' && (
            ...
            >
              <div className="lg:col-span-5 space-y-6 text-left">
                ...
                {/* Proof Badge */}
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-violet-50 dark:bg-violet-950/20 border border-violet-150 dark:border-violet-900 text-violet-700 dark:text-violet-400 text-xs font-mono font-bold">
